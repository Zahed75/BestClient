    ...
    <section className="">
      <div className="my-10 grid grid-cols-1 md:grid-cols-3 justify-between items-start gap-10">
              ...
              <div className="col-span-2">
                ...
                >
                  ...
                  {districts?.map((district, index) => (
                    <option key={index} value={district}>{district.district}</option>
                  ))}
                </select>
              </div>
              <div className="col-span-2">
        ...
        <div className="bg-[#F8F9FD] p-5 rounded-md shadow-md">
          ...
          <div className="my-5">
            {cart.map((item, index) => (
              <div key={index} className="flex justify-between items-start gap-5 my-3">
                <p className="font-semibold">{item.quantity} x</p>
                <p className="font-semibold max-w-52">{item.productName}</p>
                <p className="font-semibold">৳{item.general.salePrice * item.quantity}</p>
              </div>
            ))}
          </div>
          ...
          <div className="my-5">
            ...
            <div className="flex justify-start items-center mt-3">
              ...
              <label className="text-sm" htmlFor="card">
                Debit/Credit Cards, Mobile Banking, Internet Banking (Conditions Apply on Free Home Delivery)
              </label>
            </div>
          </div>
          ...
          <div className="flex justify-start items-center gap-5 my-10">
            ...
            <p className="text-[#3E8E7E] font-semibold">
              Check and Double-Check Your Product Details
            </p>
          </div>
          <button className="bg-[#3E8E7E] w-full py-2 rounded-md text-white">
            Place Order
          </button>
        </div>
      </div>
