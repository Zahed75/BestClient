...
export default function ProductCard({index}) {
  ...
  return (
    <div className={`w-full overflow-hidden border rounded-md p-5 ${index === 3 ? " col-span-2 md:col-span-1": ""}`}>
      <div className="relative">
        ...
        <div className="object-cover flex justify-center overflow-hidden">
          <Image src={dynacool} alt="product" className="hover:scale-105 duration-700" />
        </div>
