...
export default function ShopCard({ product }) {
  ...
  return (
    <div
      className={`w-full min-h-full overflow-hidden border rounded-md p-5 relative`}
    >
      <div className="relative">
        ...
        <div className="mt-3">
          <h4 className="text-[#202435] text-lg font-semibold h-10">
            {product?.productName}
          </h4>
          ...
          <div className="my-1 flex justify-start items-center">
            <span
              ...
              } rounded-md my-5 px-3 py-1`}
            >
              {product?.inventory?.stockStatus}
            </span>
            <span className="text-[#F16521] text-xs font-semibold my-5 ml-3 px-3 py-1 border border-[#F16521] rounded-md">
