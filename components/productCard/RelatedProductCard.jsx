...
export default function RelatedProductCard({ index }) {
  const [cartCount, setCartCount] = useState(0);

  return (
    <div
      className={`w-full overflow-hidden border rounded-md p-5 ${
      ...
      <div className="relative">
        ...
        <div className="my-3">
          ...
          <div className="text-md my-3 flex justify-start items-center gap-3">
            <p className="text-[#F16521] font-semibold">৳ 48,000</p>
            <del className="font-normal">৳ 50,000</del>
          </div>
