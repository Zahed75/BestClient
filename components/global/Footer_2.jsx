    ...
    <footer className="bg-[#f1f1f1]">
      ...
      <section className="">
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-0 text-center h-full">
          {/* First Column */}
          <div className="border-t border-gray-300 p-4 h-[138px] flex flex-col justify-center items-center">
            <p className="font-semibold text-gray-700">Returning an Item</p>
          ...
          {/* Second Column */}
          <div className="border-l border-t border-gray-300 p-4 h-[138px] flex flex-col justify-center items-center">
            <div>
              <p className="font-semibold text-gray-700">Payment Partners</p>
          ...
          {/* Third Column */}
          <div className="border-t border-b border-gray-300 p-4 h-[138px] flex flex-col justify-center items-center">
            <div>
              <p className="font-semibold text-gray-700 text-lg">Follow Us</p>
              <div className="flex justify-center space-x-4 mt-2">
                <a href="https://x.com/bestelecBD/">
                  ...
                  >
                    <path
                      d="M20.4771 0.25H24.4636L15.7542 10.2044L26.0002 23.75H17.9764L11.6929 15.5346L4.50311 23.75H0.514133L9.82977 13.1027L0.00195312 0.25H8.22695L13.9067 7.75915L20.4771 0.25ZM19.0779 21.3638H21.2869L7.02785 2.51082H4.65736L19.0779 21.3638Z"
                      fill="#4B5563"
                    />
                  </svg>
                </a>
          ...
          {/* Fourth Column */}
          <div className="border-l border-t border-b  border-gray-300 p-4 h-[138px] flex flex-col justify-center items-center">
            <div>
              ...
              <div className="flex justify-start items-center gap-2">
                  ...
                  <defs>
                    <clipPath id="clip0_2301_10106">
                      <rect
                        ...
                        height="18"
                        fill="white"
                        transform="matrix(1 0 0 -1 12.5 31)"
                      />
                    </clipPath>
                  </defs>
                </svg>
                ...
                <div>
                  <a
                    href="tel:09606111777"
                    className="text-nowrap text-gray-700 text-xl font-semibold"
                  >
                    09606 111 777
                  </a>{" "}
                  <br />
