...
export default function TopLocationBar() {
  ...
  return (
    <section className="text-[#3E445A] text-xs container px-5 md:px-44 lg:px-28 py-3 hidden min-w-full md:grid grid-cols-2 justify-stretch items-center border shadow-sm">
      <div>
