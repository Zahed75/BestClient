...
export default function SetPassword() {
  ...
  return (
    <main className="container">
      <section className="flex justify-center mx-auto py-20">
        <div className="shadow-md bg-white rounded-md p-5 w-[26rem]">
          {!confirm && (
            <div className="my-3">
              <div>
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-[#F16521] text-white py-2 my-10 rounded-md"
                >
